...
if __name__ == '__main__':
    ...
    #twitter_client = TwitterClient('pycon') # specify user
    twitter_client = TwitterClient()
    #print(twitter_client.get_user_timeline_tweets(1)) # specify how many tweets
    #print(twitter_client.get_home_timeline_tweets(1)) # specify how many tweets
    print(twitter_client.search_timeline(1))
